...
C ======================================================================
c
c     The energy decomposition is triggered via material PROPS(8) in input.
...
c            
      eqplas = statev(2)
      call rotsig(statev(2+1:ntens), drot, eplas, 2, ndi, nshr)
C ======================================================================
c      
      STRAN = STRAN + DSTRAN
      STRESS = zero
...
c          
              SYIELD = SYIEL0 +hh*(eqplas+dsqrt23*dgama)
              HARD = hh
c          
...
c      
          ...
          spd = spd + dsqrt23*dgama*(SYIEL0) + 
     1     (hh/2)*(((eqplas + dsqrt23*dgama)**2)-(eqplas**2))
C ======================================================================
c      
